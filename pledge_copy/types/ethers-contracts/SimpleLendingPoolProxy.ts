...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "./common.js"
  ...
  export interface SimpleLendingPoolProxyInterface extends Interface {
  ...
  export interface SimpleLendingPoolProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): SimpleLendingPoolProxy;
    waitForDeployment(): Promise<this>;

    interface: SimpleLendingPoolProxyInterface;

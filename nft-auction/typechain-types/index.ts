...
export type { AuctionUpgradeable } from "./contracts/AuctionUpgradeable";
export { AuctionUpgradeable__factory } from "./factories/contracts/AuctionUpgradeable__factory";
